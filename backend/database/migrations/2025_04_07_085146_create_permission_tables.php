...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            $table->engine = 'InnoDB'; // Définit explicitement le moteur InnoDB
        ...
        // Table des permissions attribuées aux modèles
        ...
        // Table des rôles attribués aux modèles
        ...
        // Table des relations rôle-permission
